...
class StreamingTextDataset(IterableDataset):
    ...
    def __init__(
        ...
        logger.info(f"Created StreamingTextDataset for {dataset_name}, "
            ...
            if self.fallback_texts:
                ...
                for text in self.fallback_texts:
                    ...
                    try:
                        ...
                        logger.warning(f"Failed to process fallback sample: {fallback_e}")
                        continue
...
def create_streaming_dataloader(
    ...
    """
    if num_workers > 0:
        logger.warning("num_workers > 0 not recommended for streaming datasets, setting to 0")
        num_workers = 0
